...
class Api:
    def __init__(self, app: FastAPI, queue_lock: Lock):
        ...
        self.add_api_route("/sdapi/v1/set-cachedmodels", self.setCachedmodelsapi,
                           methods=["POST"], response_model=models.setCachedModelsResponse)
        self.add_api_route("/sdapi/v1/get-cachedmodels", self.getCachedmodelsapi,
                           methods=["GET"], response_model=models.getCachedModelsResponse)
    ...
    def getCachedmodelsapi(self, req: models.getCachedModelsRequest = Depends()):
        ...
        if sd_models.model_data.sd_model:
            filename = arc.get_model_name(
                sd_models.model_data.sd_model.sd_model_checkpoint)
    ...
    def setCachedmodelsapi(self, req: models.setCachedModelsRequest = Depends()):
        arc = sd_models.arc
        not_exist = arc.set_specified(
            req.gpu_cached_models, req.ram_cached_models)
