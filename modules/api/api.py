...
from modules.sd_models import checkpoints_list, unload_model_weights, reload_model_weights, get_arc
...
class Api:
    ...
    def cachedmodelsapi(self, req: models.CachedModelsRequest = Depends()):
        # copy from check_progress_call of ui.py
        arc = get_arc()
        cudas = arc.get_cudas()
        rams = arc.get_cudas()
